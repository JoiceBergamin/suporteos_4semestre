...
public class UserDTO {
    ...
    @NotBlank(message = "O campo nome não poder ser branco")
    protected String firstName;

    @NotNull(message = "O campo sobrenome não pode ser nulo")
    @NotBlank(message = "O campo sobrenome não poder ser branco")
    ...
    @NotBlank(message = "O campo email não poder ser branco")
    protected String email;

    @NotNull(message = "O campo senha não pode ser nulo")
    @NotBlank(message = "O campo senha não poder ser branco")
